...
//  GLuint programID = LoadShaders("shaders/Passthrough.vertexshader", "shaders/WobblyTexture.fragmentshader");
...
//    GLuint Texture = loadDDS("mesh/ExampleBillboard.DDS");
//    GLuint Texture = loadDDS("mesh/Fire.dds");
...
//    bool res = loadOBJ("mesh/cube.obj", vertices, uvs, normals);
    bool second_object = loadOBJ("mesh/goose.obj", vertices, uvs, normals);
...
//		translação que move o macaco e o ganso
//		ModelMatrix = translate(ModelMatrix, glm::vec3(-3, 0, -7));
